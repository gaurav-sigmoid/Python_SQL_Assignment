...
class Employee:
    ...
    def list_of_employees(self):
        connection = Create_connection.get_connection(self)
        ...
        print(df)
        final_data = pd.ExcelWriter('Output_Files/query1.xlsx')
    ...
    def total_compensation(self):
        ...
        print("\n\n", df.head())
        writer = pd.ExcelWriter('Output_Files/query2.xlsx')
    ...
    def file_to_query(self, data, file):
        engine = Create_connection.get_engine(self)
        try:
            if data == 'Q2':
    ...
    def file_to_table(self):
        with pd.ExcelFile('Output_Files/query2.xlsx') as xls1:
    ...
    def compensation_at_dept_level(self):
        with pd.ExcelFile('Output_Files/query2.xlsx') as xls2:
        ...
        final_data = pd.ExcelWriter('Output_Files/query4.xlsx')
